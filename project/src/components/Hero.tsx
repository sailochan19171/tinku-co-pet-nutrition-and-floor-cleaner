...
const Hero: React.FC<HeroProps> = ({ onStartQuiz }) => {
  ...
  // Use provided transparent PNG directly from public folder
  const [heroSrc, setHeroSrc] = useState<string>('/hero-beagle.png');
  useEffect(() => {
    // No processing needed; just set the path to the copied image
    setHeroSrc('/hero-beagle.png');
  }, []);
  return (
