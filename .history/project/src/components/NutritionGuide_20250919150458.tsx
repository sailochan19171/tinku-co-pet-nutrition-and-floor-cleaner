...
const Circle: React.FC<{ text: string }> = ({ text }) => (
  <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mr-4 text-white font-bold select-none">
    {text}
  </div>
);
