...
const Badge: React.FC<{ text: string }> = ({ text }) => (
  <div className="w-16 h-16 bg-blue-600 flex items-center justify-center mx-auto mb-4 border border-gray-300 text-white font-bold">
    {text}
  </div>
);
    ...
    <section id="about" className="section-premium bg-white">
      <div className="container-premium">
        <div className="text-center mb-16">
          ...
          <h2 className="heading-section mb-3">About</h2>
          <h3 className="text-3xl font-semibold text-gray-800 mb-6">Tinku & Co.</h3>
