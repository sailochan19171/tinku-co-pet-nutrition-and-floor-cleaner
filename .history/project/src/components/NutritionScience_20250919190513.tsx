  ...
  useEffect(() => {
    ...
    img.onload = () => {
      ...
      for (let i = 0; i < d.length; i += 4) {
        ...
        const g = d[i + 1];
        const b = d[i + 2];
        // Fully remove near-black; soften very dark grays to avoid halo
        if (r < 20 && g < 20 && b < 20) {
          d[i + 3] = 0; // transparent
      ...
      <div className="container-premium">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              <img
                src="/right-nutrition.jpg"
                alt="Complete pet wellness - dog and cat with food"
                className="w-full rounded-lg shadow-lg object-contain mix-blend-screen"
              />
            </div>
          </div>
        </div>
